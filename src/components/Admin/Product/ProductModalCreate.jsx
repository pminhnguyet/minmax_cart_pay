...
import {  callCreateProduct, callFetchCategory, callUploadProductImg } from '../../../services/api';
...
const ProductModalCreate = (props) => {
    ...
    const onFinish = async (values) => {
      ...
      const res = await callCreateProduct(thumbnail, slider,mainText, author, price, sold, quantity, category );
      if(res && res.data) {
